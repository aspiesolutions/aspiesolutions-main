...
pub async fn handle_graphql_post_request(token:Auth0BearerToken,db: rocket_db_pools::Connection<crate::lib::Db>,schema: &State<Schema>,body: juniper_rocket::GraphQLRequest, ) -> juniper_rocket::GraphQLResponse  {
...
#[rocket::get("/?<query>")]
pub async fn handle_graphql_get_query(token:Auth0BearerToken,db: rocket_db_pools::Connection<crate::lib::Db>,schema: &State<Schema>,query:juniper_rocket::GraphQLRequest)-> juniper_rocket::GraphQLResponse {
