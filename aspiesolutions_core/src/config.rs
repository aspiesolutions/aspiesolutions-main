...
impl Auth0Config {
    ...
    pub fn new_from_env() -> Self {
        Self {
            domain: std::env::var(ENV_KEY_AUTH0_DOMAIN).unwrap_or_else(|_| panic!(
                "Envrionment Variable {} must be defined",
                ENV_KEY_AUTH0_DOMAIN
            )),
            client_id: std::env::var(ENV_KEY_AUTH0_CLIENT_ID).unwrap_or_else(|_| panic!(
                "Envrionment Variable {} must be defined",
                ENV_KEY_AUTH0_DOMAIN
            )),
            client_secret: std::env::var(ENV_KEY_AUTH0_CLIENT_SECRET).unwrap_or_else(|_| panic!(
                "Envrionment Variable {} must be defined",
                ENV_KEY_AUTH0_DOMAIN
            )),
            audience: std::env::var(ENV_KEY_AUTH0_AUDIENCE).unwrap_or_else(|_| panic!(
                "Envrionment Variable {} must be defined",
                ENV_KEY_AUTH0_DOMAIN
            )),
        }
