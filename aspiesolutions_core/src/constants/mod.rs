...
pub const ENV_KEY_AUTH0_CLIENT_ID: &str = concatcp!(AUTH0_ENV_PREFIX, ENV_SEPERATOR, "CLIENT_ID");
...
pub const ENV_KEY_AUTH0_AUDIENCE: &str = concatcp!(AUTH0_ENV_PREFIX, ENV_SEPERATOR, "AUDIENCE");
